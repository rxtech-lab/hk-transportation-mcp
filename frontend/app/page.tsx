...
export default function Home() {
    ...
    useChat({
      ...
      onToolCall({ toolCall }) {
        ...
        if (toolCall.toolName === "display_route") {
          ...
          // Only the model-facing summary is produced here — the card's own
          // data is filled in by the sweep below, which also covers restored
          // sessions where onToolCall never fires. Both share one request.
          //
  ...
  //
  // onToolCall only fires while a stream is live, so messages restored from
